...
const JuliaSilotypemap=[:Int64 => DB_LONG_LONG, ]
const SiloJuliatypemap=[DB_LONG_LONG => :Int64, ] # Previous inverse
const enummap=[:DB_INT => DB_INT,]
const enummapinv=[DB_INT => :DB_INT] # Previous inverse
end #module
